...
import copy
import labeldir
from vary_gkbar import submit_to_cluster
sys.path.append('../..')
...
if __name__ == '__main__':
    ...
    figmoddir = '../../figures/BSNaKResetM3'
    ...
    fxvec = np.linspace(0.04, 0.06, 10)
    xname = 'std'
    tau = 30
    # tau = 5
    ...
    statname = 'cv'
    targ_list = [0.8, 1.0, 1.2]

    gkbarli = [3e-3]#, 5e-3, 15e-3]
    bracketli = [(0.0, 0.06)]#, (0.04, 0.06), (0.065, 0.08)]
    # varygk_contours(gkbarli, bracketli, subctrdir, statname, targ_list, fxvec, xname, tau, ttime)

    statname_list = ['frt', 'cv']
    targli_list = [[5, 10, 20], [0.8, 1.0, 1.2]]
    marker_list = ['o', '+']
